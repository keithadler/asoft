/* Generated by tools/mkfont.py -- edit the glyphs there, not here. */
#include "applefont.h"

const unsigned char apple_font[APPLE_FONT_CHARS][8] = {
    ...
    { 0x10, 0x10, 0x08, 0x04, 0x02, 0x01, 0x01, 0x00 },   /* backslash */
